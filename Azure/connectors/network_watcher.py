...
class AzureNetworkWatcherConnectorConfig(DefaultConnectorConfiguration):
...
class AzureNetworkWatcherConnector(AsyncConnector):
    """AzureNetworkWatcherConnector."""

    name = "AzureNetworkWatcherConnector"
    module: Module
    configuration: AzureNetworkWatcherConnectorConfig
    ...
    async def get_azure_network_watcher_data(self) -> list[str]:
        """
        Get Azure Network Watcher data.
        ...
        while self.running:
            try:
                ...
                while self.running:
                    ...
                    message_ids: list[str] = loop.run_until_complete(self.get_azure_network_watcher_data())
