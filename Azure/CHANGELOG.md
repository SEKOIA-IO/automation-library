...
- Fix resource not found exception
- Add checkpoint store initialization to prevent 404 errors when creating ownership blobs

## 2025-11-04 - 2.9.1

### Fixed

- Decrease the `AZURE_BATCH_SIZE` default value to 1000 in the Azure Blob Storage connectors

## 2025-10-10 - 2.9.0

### Fixed

- Cleanup Azure EntraId Connector
