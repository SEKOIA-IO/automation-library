...
class TestMISPIDSAttributesToIOCCollectionTrigger:
    ...
    def test_initialize_http_session_defaults(self, trigger):
        ...
        assert trigger.http_session.trust_env is True
    ...
    def test_extract_ioc_value_composite(self, trigger):
        ...
        assert trigger.extract_ioc_value(Mock(type="ip-dst|port", value="2001:db8::1|443")) == "2001:db8::1"
    ...
    def test_validate_ioc_ipv4_valid(self, trigger):
        ...
        #Port is not extracted by extract_ioc_value()
    ...
    def test_validate_ioc_ipv4_invalid(self, trigger):
        ...
        #Port is not extracted by extract_ioc_value()
        assert trigger.validate_ioc_value("1.2.3.4|22", "ip-dst|port") is False
    ...
    def test_validate_ioc_ipv6_invalid(self, trigger):
        ...
        #Port is not extracted by extract_ioc_value()
        assert trigger.validate_ioc_value("2001:db8::1|22", "ip-dst|port") is False
