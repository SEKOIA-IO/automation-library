...
async def test_defined_queue_url(sqs_wrapper_with_url_configuration: SqsConfiguration, session_faker: Faker):
    """
    Test the queue url provided in the module configuration is considered

    Args:
        sqs_wrapper_with_url_configuration: SqsConfiguration
        session_faker: Faker
    """
    sqs_wrapper = SqsWrapper(sqs_wrapper_with_url_configuration)

    with patch("aws_helpers.sqs_wrapper.SqsWrapper.get_client"):
