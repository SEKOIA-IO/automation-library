...
class EntraIDAssetConnector(AssetConnector):
    ...
    @cached_property
    def client(self) -> EntraIDApiClient:
        """
        Get the API client for the Entra ID asset connector.
        This client is used to interact with the Entra ID API.
        """
        return EntraIDApiClient(
