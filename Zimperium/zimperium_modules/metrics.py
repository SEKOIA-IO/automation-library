...
INCOMING_MESSAGES = Counter(
    ...
    documentation="Number of messages collected from Zimperium",
    namespace=prom_namespace_zimperium,
...
FORWARD_EVENTS_DURATION = Histogram(
    ...
    documentation="Duration to collect and forward events from Zimperium",
    namespace=prom_namespace,
    labelnames=["intake_key"],
)
