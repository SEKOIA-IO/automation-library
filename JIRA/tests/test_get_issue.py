            ...
            "issuelinks": [
                {
                    ...
                    "type": {"id": "10000", "inward": "depends on", "name": "Dependent", "outward": "is depended by"},
                },
                {
                    "id": "10002",
                    "inwardIssue": {
            ...
            "worklog": [
                {
                    ...
                    "comment": {
                        ...
                        "version": 1,
                        "content": [
                            {"type": "paragraph", "content": [{"type": "text", "text": "I did some work here."}]}
                        ],
                    },
                    "id": "100028",
                    "issueId": "10002",
...
def test_get_issue(action: JIRAGetIssue, issue_1):
    with requests_mock.Mocker() as mock:
        mock.register_uri(
            "GET",
            "https://test.atlassian.net/rest/api/3/issue/ED-1",
            json=issue_1,
        )
        args = JIRAGetIssueArguments(issue_key="ED-1")
        action.run(args)
