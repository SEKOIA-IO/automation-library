...
class ExtraHopApiAuthentication(AuthBase):
    def __init__(
        self,
        base_url: str,
        client_id: str,
        ...
        self.__api_credentials: ExtraHopApiCredentials | None = None
    ...
    def get_credentials(self) -> ExtraHopApiCredentials:
        ...
        if self.__api_credentials is None or current_dt + timedelta(seconds=300) >= self.__api_credentials.expires_at:
            ...
            credentials = ExtraHopApiCredentials()
