...
from bitdefender.actions import IsolateEndpointAction, DeisolateEndpointAction, CustomScanEndpointAction, ScanEndpointAction, QuarantineFileAction, KillProcessAction, UpdateCommentIncidentAction, UpdateIncidentStatusAction, PushBlockAction, RemoveBlockAction, RestoreQuarantineFileAction, GetBlockListAction
