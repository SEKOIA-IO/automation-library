...
def test_create_isolate_endpoint(symphony_storage):
    ...
    action = IsolateEndpointAction(data_path=symphony_storage)
    action.module.configuration = module_configuration

    with requests_mock.Mocker() as mock:
        mock.register_uri(
            "POST",
            "mock://cloudgz.gravityzone.bitdefender.com/api/v1.0/jsonrpc/incidents/createIsolateEndpointTask",
            json={"result": True},
            status_code=200,
        )
...
def test_create_isolate_endpoint_error(symphony_storage):
    ...
    with requests_mock.Mocker() as mock:
        ...
        try:
            ...
            assert str(e) == "400 Client Error: None for url: mock://cloudgz.gravityzone.bitdefender.com/api/v1.0/jsonrpc/incidents/createIsolateEndpointTask"