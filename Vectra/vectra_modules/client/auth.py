...
class VectraApiAuthentication(AuthBase):
    def __init__(
        self,
        base_url: str,
        client_id: str,
        client_secret: str,
        ratelimit_per_second: int = 1,
    ) -> None:
        self.__authorization_url = urljoin(base_url, "oauth2/token")
        self.__client_id = client_id
        self.__client_secret = client_secret
        self.__api_credentials: VectraApiCredentials | None = None
    ...
    def get_credentials(self) -> VectraApiCredentials:
        with self.__lock:
            ...
            if (
                ...
                credentials = VectraApiCredentials()
