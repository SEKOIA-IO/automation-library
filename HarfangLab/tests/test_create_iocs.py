...
def test_creating_iocs():
    ...
    with requests_mock.Mocker() as mock:
        mock.register_uri(
            "POST",
            "https://test.hurukau.io/api/data/threat_intelligence/IOCRule/",
            json={
                "id": "2f17fbcc-ed10-40ea-a3a9-92ecdc32ce6f",
                "test_maturity_current_count": 0,
                "test_maturity_delay": 7,
                "test_maturity_threshold": 10,
                "alert_count": 0,
                "source_id": "3cf6dc0e-3d81-4cae-9848-c5294655e2be",
                "last_modifier": {"id": 3, "username": "sekoia"},
                "last_update": "2024-10-24T10:52:02.639015Z",
                "creation_date": "2024-10-24T10:52:02.639129Z",
                "enabled": True,
                "block_on_agent": False,
                "quarantine_on_agent": False,
                "endpoint_detection": False,
                "hl_status": "stable",
                "hl_testing_start_time": "2024-10-24T10:52:02.639174Z",
                "silent": False,
                "rule_level": None,
                "rule_level_override": None,
                "type": "ip_both",
                "value": "77.91.78.118",
                "comment": None,
                "info": None,
                "category": None,
                "description": "https://app.sekoia.io/intelligence/objects/indicator--f24eb993-4ece-47ff-90e1-fa3f87de85dc",
                "references": [],
                "source": "3cf6dc0e-3d81-4cae-9848-c5294655e2be",
            },
        )
