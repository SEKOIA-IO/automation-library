...
from withsecure.constants import API_LIST_INCIDENT_URL
from withsecure.update_incident_status import ActionArguments, UpdateStatusIncident
...
def action(data_storage):
    ...
    action = UpdateStatusIncident(module=module, data_path=data_storage)
...
def test_run_to_update_status_for_an_incident(action):
    response_payload = {
        "multistatus": [
