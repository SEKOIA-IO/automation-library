...
from withsecure.enumerate_processes import ActionArguments, EnumerateProcesses
...
def action(data_storage):
    ...
    action = EnumerateProcesses(module=module, data_path=data_storage)
...
def test_run_enumerate_processes(action):
    ...
    with requests_mock.Mocker() as mock_requests:
        ...
        response = action.run(
            arguments=ActionArguments(
                target="e297cbf5-ba53-4e66-909c-6d87527c4e98", organization_id="7301935a-6715-473b-a5af-9130e8c84821"
            )
        )
