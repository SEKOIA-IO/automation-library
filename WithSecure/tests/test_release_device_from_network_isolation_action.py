...
def test_run_to_release_device_from_network_isolation(action):
    response_payload = {
        "multistatus": [
            {"target": "e297cbf5-ba53-4e66-909c-6d87527c4e98", "status": 202, "operationId": "1766440346498445629"}
        ],
        "transactionId": "0000-861a55bbfda245dc",
    }
